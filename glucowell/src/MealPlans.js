...
// const schema = {
//   description:
//     "Provide constructive criticism and alternative meal options on a user's planned three meals of the day: breakfast, lunch, and dinner. Each meal should have its own object with separate feedback and alternatives.",
...
//         type: SchemaType.STRING,
//         description:
//           "Some criticism on the user's choice for the meal (either breakfast, lunch, or dinner. NOT for all three.) Do not leave this field empy.",
//       },
//       alternatives: {
//         type: SchemaType.STRING,
//         description:
//           "Provide alternative healthier meal substitutions for the user. (either breakfast, lunch, or dinner. NOT for all three.) Try to provide minor healthier substitutions to the meal that the user inputted, instead of providing alternatives that are completely unrelated to the user's original meal plan. Do not leave this field empy.",
//       },
//     },
